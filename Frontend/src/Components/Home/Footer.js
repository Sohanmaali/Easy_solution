...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-[var(--dark-blue)]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-white font-medium">
                <li className="mb-2 hover:text-[var(--mid-blue)]">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-2 hover:text-[var(--mid-blue)] text-white">
                  <a href="https://linkedin.com/" className="hover:underline ">
                    Linkedin
                  </a>
                </li>
                <li className="text-white mb-2 hover:text-[var(--mid-blue)]">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-2">
                  <h1> Email : sohanmaali4@gmail.com</h1>
                </li>
                <li className="mb-2">
                  <h2>Phone : 6232389832</h2>
                </li>
                <li className="mb-2">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              ...
              className="text-white hover:text-[var(--mid-blue)] dark:hover:text-[var(--mid-blue)]"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              ...
              className="text-white hover:text-[var(--mid-blue)] dark:hover:text-[var(--mid-blue)] ms-5"
            >
              <svg
                className="w-6 h-5"
                aria-hidden="true"
